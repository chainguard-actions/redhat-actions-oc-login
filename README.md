...
Hardened by [Chainguard](https://www.chainguard.dev) from the upstream action at [https://github.com/redhat-actions/oc-login](https://github.com/redhat-actions/oc-login).
